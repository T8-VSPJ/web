	                                  ...
	                                  $fileN="photos/clanekUvod".$idBox."*";
													...
													echo		'</a>
															...
															<div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow" style="position:absolute;">
																<!-- category -->
																<a class="p-1 badge badge-primary rounded-0" href="http://localhost/pages/clanky.php?clanek'.$rowBox['id'].'">'.$rowBox['zarazeni'].'</a>

																<!--title and description-->
																<a href="http://localhost/pages/clanky.php?clanek'.$rowBox['id'].'">
