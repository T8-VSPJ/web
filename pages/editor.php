  ...
  <?php
    if(isset($_SESSION['idUzivatele'])){
      ...
      echo '<div class="container">
          <div class="row">
            <h1 class="uvodVety">Editor článků</h1>
          </div>
          <form class="editorPravidel" action="../scripts/pridatClanek.php" method="post" enctype="multipart/form-data">';
        echo '<input type="file" name="foto" style="margin-bottom:10px;"><br>
  	          <input type="text" class="form-control" style="width:30%;" placeholder="Titulek" name="textTitulek" id="titulek"><br>
  	          <input type="text" class="form-control" style="width:50%;" placeholder="Krátký popis" name="textPopis" id="popis"><br>
							<select class="form-control" name="zarazeniPrispevku">
        ...
        echo  '</textarea>
            ...
            <button type="submit" class="btn btn-secondary" data-dismiss="modal" name="submitBtn" style="margin-top: 15px;">Předat článek ke schválení</button>
          </form>
    </div>
    <footer id="sticky-footer" class="page-footer py-4 bg-light">
