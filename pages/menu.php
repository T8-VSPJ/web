        ...
        <div class="ml-auto" id="profilLinky">
          <?php
            if(!isset($_SESSION['idUzivatele'])){
              ...
              <a class="dropdown-item" href="zpravy.php">Zprávy</a>';
                            if($_SESSION['stavAutor'] == 1){
                              echo	'<a class="dropdown-item"'; if($_SESSION['ban'] == 1 ){echo 'disabled="disabled"';} echo ' href="editor.php">Přidat článek</a>';
                            }
							if($_SESSION['stavAutor'] == 1 || $_SESSION['stavRedaktor'] == 1 || $_SESSION['stavRecenzant'] == 1 || $_SESSION['stavSefredaktor'] == 1 || $_SESSION['stavAdmin'] == 1){ 	//Přidání události
								echo	'<a class="dropdown-item"'; if($_SESSION['ban'] == 1 ){echo 'disabled="disabled"';} echo ' href="odeslaneClanky.php">Schránka příspěvků</a>';
                            }
                            if($_SESSION['stavAdmin'] == 1){
                             
								echo	'<a class="dropdown-item" href="amenu.php">Admin menu</a>';
                            }
